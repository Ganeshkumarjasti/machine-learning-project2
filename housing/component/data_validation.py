...
class DataValidation:
    ...
    def get_train_and_test_df(self):
        try:
            train_df = pd.read_csv(self.data_ingestion_artifact.tarin_file_path)
    ...
    def is_train_test_file_exists(self):
        try:
            logging.info("Checking if training and tes file is available")
            ...
            if not is_available:
                training_file = self.data_ingestion_artifact.tarin_file_path
